$(document).ready(function() {
  //게시물 등록 시 게시물이 공백인지 아닌지 확인하는 기능.
      ...
      $.ajax({
        ...
        success: function(data){
          ...
          if(data.result == true){
            ...
            //게시물 데이터 id가 center인 엘리먼트에 넣기 위해 게시물의 HTML 태그를 만듦.
  ...
  //댓글 게시 버튼 클릭 이벤트
  //댓글 게시 버튼 클릭 이벤트는 지금까지와는 다른 모습의 클릭 이벤트다.
  ...
  $(document).on('click', '.likeBtn', function(){
    ...
    //likes 클래스에 mode의 값 save와 공감할 콘텐츠 번호 전송
    $.ajax({
